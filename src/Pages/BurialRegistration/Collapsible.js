...
export default function Collapsible() {
  ...
  return (
    <div className="flex flex-col items-center">
      <div
        className="subtitle-font text-3xl bolded text-center "
        {...getToggleProps()}
      >
        ...
        <div className="">
          ...
          >
            <div className="mb-6">
              <label
                for="ppaid"
                className="text-font text-xl block text-gray-800 mb-2"
              >
              ...
              <input
                ...
                required
                className="w-1/2 px-4 py-2 border rounded-md focus:outline-none focus:border-green-600"
            ...
            <label for="deceasedDay" className="head">
              Deceased Day:{' '}
            </label>
            <input
              type="number"
            ...
            <br></br>
            <br></br>
            <label for="deceasedMonth" className="head">
              Deceased Month:{' '}
            </label>
            <input
              id="deceasedMonth"
            ...
            <br></br>
            <br></br>
            <label for="deceasedYear" className="head">
              Deceased Year:{' '}
            </label>
            <input
              type="number"
            ...
            <label for="FirstName" className="head">
              First Name
            </label>
            <br></br>
            <input
            ...
            <br></br>
            <br></br>
            <label for="LastName" className="head">
              Last Name
            </label>
            <br></br>
            <input
            ...
            <br></br>
            <br></br>
            <label for="Address" className="head">
              Street Address
            </label>
            <br></br>
            <input
            ...
            <br></br>
            <br></br>
            <label for="Country" className="head">
              Country
            </label>
            <br></br>
            <input
            ...
            <br></br>
            <br></br>
            <label for="State" className="head">
            ...
            <br></br>
            <br></br>
            <label for="ZipCode" className="head">
              Zip Code
            </label>
            <br></br>
            <input
            ...
            <br></br>
            <br></br>
            <label for="Speshial Requeshts" className="head">
              Special Requests
            </label>{' '}
            <br></br>
            <input
            ...
            <br></br>
            <label for="WeekendServices" className="head">
            ...
            <br></br>
            <br></br>
            <label for="ChildQ" className="head">
