...
export default function Collapsible() {
  ...
  return (
    <div className="flex flex-col items-center">
      <div
        className="subtitle-font text-3xl bolded text-center w-96"
        {...getToggleProps()}
      >
          ...
          >
            <div className="mt-6 mb-6 mx-auto">
              <label htmlFor="ppaid" className="block text-gray-800 mb-2">
                <p className="font-normal text-lg">How much was prepaid?</p>
              </label>
              <input
                type="number"
                id="ppaid"
                ...
                required
                className="w-72 px-4 py-2 border rounded-md focus:outline-none focus:border-green-600"
            ...
            <div className="mb-6">
              <label for="purchaser" className="block text-gray-800 mb-2">
                <p className="font-normal text-lg">Type of purchaser?</p>
              </label>
              <input
                id="TypeOPurchaser"
                name="purchaser"
            ...
            <div className="mb-6">
              <label for="deceasedName" className="block text-gray-800 mb-2">
                <p className="font-normal text-lg"> Name of Deceased </p>
              </label>
              <input
                type="text"
                id="deceasedName"
            ...
            <div className="mt-6 mb-6 mx-auto">
              <label for="deceasedDate" className="block text-gray-800 mb-2">
                <p className="font-normal text-lg"> Deceased Date: </p>
              </label>
              <input
                type="date"
                id="deceasedDate"
            ...
            <p className="subtitle-font text-lg mb-4">Billing Information</p>
            <div className="mt-6 mb-6 mx-auto">
              <label for="FirstName" className="block text-gray-800 mb-2">
                <p className="font-normal text-lg"> First Name:</p>
              </label>
              <input
                type="text"
                id="FirstName"
            ...
            <div className="mt-6 mb-6 mx-auto">
              <label for="LastName" className="block text-gray-800 mb-2">
                <p className="font-normal text-lg"> Last Name:</p>
              </label>
              <input
                type="text"
                id="LastName"
            ...
            <div className="mt-6 mb-6 mx-auto">
              <label for="Address" className="block text-gray-800 mb-2">
                <p className="font-normal text-lg"> Street Address</p>
              </label>
              <input
                type="text"
                id="Address"
            ...
            <div className="mt-6 mb-6 mx-auto">
              <label for="ZipCode" className="block text-gray-800 mb-2">
                <p className="font-normal text-lg"> Zip Code </p>
              </label>
              <input
                type="number"
                id="ZipCode"
            ...
            <p className="subtitle-font text-lg mb-4">Pricing Calculation</p>
            ...
            {calcPrice ? (
              ...
              <button
                class="mx-auto border-0 bg-gray-500 px-8 py-2 mt-8 mb-4 rounded-full text-white text-md flex justify-center text-font"
