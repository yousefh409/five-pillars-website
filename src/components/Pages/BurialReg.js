...
function Collapsible() {
    ...
    const handleSubmit = (e) => {
        ...
        console.log(firstName, lastName, city, country, state, zip, extras, specials)
        axios.post('https://sheet.best/api/sheets/6eaa6a8b-4786-452e-8166-55802a9d7f3d', data).then((response) => {
            ...
            <div {...getCollapseProps()}>
                <div className="content">
                    ...
                    >
                        ...
                        {calcPrice ? ''  : <button onClick={()=> calculatePrice()}> Calculate Price</button>}
    ...
    return (
        <div className="collapsible">
            ...
            <div {...getCollapseProps()}>
                <div className="content">
                    <br></br>
                    <p>Placeholder for the new form</p>
                </div>
            </div>
        </div>
    );
...
export const BurialReg = () => {
    return (
        <div>
            <h1>Burial Registration </h1><br></br>
            <Collapsible />
            <Collapsibles />
