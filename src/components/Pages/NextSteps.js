...
export const NextSteps = () => {
  return (
    ...
    <p> 
        ...
        Minhaa khalaqnaa kum[From the earth did We create you]<br/>
        Wa feehaa Nu’eedu kum[And into it shall We return you ] <br/>
        Wa minhaa nukhrijukum taaratan ‘ukhraa[And from it shall We bring you out once again] <br/>
    </p>
    ...
    <p> Some things to keep in mind: <br/>
        ...
        <ol>Then say : “Allahu Akbar” and recite the Tashahood . </ol> <br/>
        ...
        <ol> Then say: “Allahu Akbar”</ol> <br/>
        ...
        <ol> 6. Transportation to the Cemetery </ol> <br/>
